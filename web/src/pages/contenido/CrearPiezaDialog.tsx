  ...
  async function enviar(e: React.FormEvent) {
    ...
    try {
      if (tipo === 'posts') {
        ...
        await tamixApi.crearNota({ body: notaBody });
      }
        ...
        <form onSubmit={enviar} className="space-y-4">
          {tipo === 'posts' ? (
            <>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-1.5">
                  <Label htmlFor="coverUrl">Portada (URL, opcional)</Label>
                  <Input id="coverUrl" type="url" value={coverUrl} onChange={(e) => setCoverUrl(e.target.value)} placeholder="https://…" />
                </div>
                <div className="space-y-1.5">
